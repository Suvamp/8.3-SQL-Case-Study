...
SELECT c.name, CONCAT(firstname, ' ', surname) AS fullname, c.cost
FROM Members as m
INNER JOIN(SELECT name,
            ...
            WHERE starttime BETWEEN '2012-09-14 00:00:00' AND '2012-09-15 00:00:00') AS c
ON m.memid = c.memid
WHERE c.cost > 30
ORDER BY c.cost > 30
